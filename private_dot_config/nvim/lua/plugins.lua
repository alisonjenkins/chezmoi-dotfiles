...
return require('packer').startup(function(use)
    ...
    use {'ruifm/gitlinker.nvim', config = CONFIG_GITLINKER() }                                                   -- (lua) Adds the ability to copy links to lines / blocks of code in git into your clipboard using <leader>gy
