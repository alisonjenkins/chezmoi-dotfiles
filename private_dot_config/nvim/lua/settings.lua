...
vim.o.guifont = "FiraCode Nerd Font Mono:h15:b"          -- Set the font used by vim GUIs
...
vim.o.undofile = false                                   -- enable persistent undo (meaning if you quit Neovim and come back to a file and want to undo previous changes you can)
