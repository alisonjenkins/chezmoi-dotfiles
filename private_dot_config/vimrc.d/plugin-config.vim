...
source ~/.config/vimrc.d/plugin-config/suda.vim
source ~/.config/vimrc.d/plugin-config/tagbar.vim
source ~/.config/vimrc.d/plugin-config/terraform-completion.vim
source ~/.config/vimrc.d/plugin-config/terraform.vim
source ~/.config/vimrc.d/plugin-config/todo-txt.vim
